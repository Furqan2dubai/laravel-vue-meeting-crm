...
const props = defineProps(['data'])
  ...
  const load_data = ()=>{ 
    ...
    axios.post("/api/get_data/Meeting_payments/"+page.value, {
        field1: 'staff_id', 
      ...
      if(res.data.success){    
        ...
        if(res.data.total){
          ...
          filter.value.total_payments = res.data.total;
        }
...
<template >  
  <VRow > 
    <VCol cols="12"> 
      <VBtn class="d-flex my-3 ml-auto">Add Payment</VBtn>
    </VCol>
    <VCol cols="12"> 
        ...
        <tbody>
          ...
          > 
            ...
            <td class="text-center" > 
              <a :href="`payments/view/${ val.id }`" target="_blank"> {{ val.payment_no }} </a>
            </td>
            <td class="text-center" > 
